...
int main(){
   ...
   printf("%d\n",arr1[5]);//i try to print the index 5 value in the array
   printf("%d\n",arr2[4]);//i try to print the index 4 value in the array
   printf("%d\n",arr3[3]);//i try to print the index 3 value in the array
